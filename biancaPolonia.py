                                ...
                                with col1:
                                    ...
                                    with col2:
                                        ...
                                        with col3:
                                            ...
                                            for index in range(len(ml_gyro[0:start_gyro3]) - 1, start_gyro3 + 100, -1):
                                                valor = ml_gyro[index]
                                                if valor > 0.15:
                                            ...
                                            ax.plot(
                                                [time_original_kinem[onsets[1]],time_original_kinem[onsets[2]]], [0,30], 'b-')
                                            ax.plot(
                                                [time_original_kinem[offsets[1]],time_original_kinem[offsets[2]]], [0,30], 'b-')
